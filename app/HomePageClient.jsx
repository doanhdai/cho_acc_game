      ...
      <section className="section" style={{ paddingTop: '40px' }}>
        <div className="container">
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 28 }}>
            ...
            {totalCount >= 30 && (
              <Link href="/search" className="btn btn-outline btn-sm">Xem tất cả <FiArrowRight /></Link>
            )}
          </div>
      ...
      <section className="section" style={{ paddingTop: 0 }}>
        <div className="container">
          <div style={{
            ...
            <Link href="/sell" className="btn btn-primary" style={{ background: '#4f46e5', color: 'white', border: 'none', padding: '12px 28px', fontSize: 14, fontWeight: 700 }}>Đăng bán acc ngay</Link>
          </div>
        </div>
      </section>
