      ...
      <div className="container" style={{ maxWidth: 1100 }}>
        ...
        {hasInsufficientBalance && (
          <div style={{
            ...
            <button className="btn btn-primary btn-sm" onClick={() => navigate('/deposit')} style={{ borderRadius: 6 }}>Nạp tiền ngay</button>
          </div>
        )}
            ...
            <div className="card" style={{ padding: 24, borderRadius: 'var(--radius-lg)' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                ...
                >
                  ...
                  <div style={{ fontSize: 11, color: 'var(--text-muted)', marginTop: 4 }}>Tối đa 15 ảnh chụp kho đồ, trang phục</div>
                </div>
                    ...
                    {images.map((img, i) => (
                      <div key={i} style={{ position: 'relative', aspectRatio: '4/3', borderRadius: 4, overflow: 'hidden', border: '1px solid var(--border)' }}>
                        ...
                        <button
                          ...
                          style={{
                            position: 'absolute', top: 2, right: 2, background: 'rgba(229,57,53,0.9)', color: 'white',
